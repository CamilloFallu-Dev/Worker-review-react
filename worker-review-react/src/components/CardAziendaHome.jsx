...
export default function CardAziendaHome() {
  ...
  return (
    <div className="flex flex-wrap justify-center sm:flex-col m-2 gap-5 lg:flex-row md:flex-row">
        ...
        companies.map((company, index) => {
          ...
          return (
            <Link
              ...
              className="flex flex-col sm:flex-row sm:w-full md:mb-0 p-5 shadow-md rounded-xl lg:w-1/3 md:w-1/2 w-full bg-white"
            >
              <img
                src={company.url}
                alt={company.name}
