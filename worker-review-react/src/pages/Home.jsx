    ...
    <div>
      ...
      <div>
        ...
        <p className="p-4 text-sm">
          ...
          porro adipisci reprehenderit dicta deserunt obcaecati minus odio, quis
          voluptas, natus qui magni ea sit possimus alias incidunt odit mollitia
          ex. Lorem ipsum dolor sit, amet consectetur adipisicing elit.
          Voluptates debitis minus unde facere! Reprehenderit, autem! Eligendi,
          explicabo molestiae debitis provident reprehenderit, saepe recusandae
          eum numquam nobis velit magnam expedita necessitatibus.
        </p>
      </div>
    </div>
  );
